...
ESERCIZIO:
    - [x] creare la funzione **searchStatus** (fare test)
    - [x] usare la funzione **searchStatus** insieme a **searchText**
    - [x] visualizzare un feedback per l'utente della ricerca "cosa ho cercato e con che criterio" (se ho cercato lo status in progress, vedo il radio button attivo)
